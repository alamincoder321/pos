...
<body>
    <div style="display:flex;">
        <div class="navleft" style="width:65%">
            <h6 style="box-sizing:border-box; padding-left:25px;">ক্যাশ মেমো-</h6>
        ...
        <div style="width:35%; box-sizing: border-box; padding-top: 10px; padding-left: 20px;">
            ...
            <div style="background: wheat; width: 100%; display:flex;">
                ...
                <p style="padding-top: 9px;padding-left: 12px;">{{$invoice->chalan_date}}</p>
            </div>
        </div>
    </div>
    ...
    <section>
        <div style="display: flex;border-bottom: 1px solid black;">
            <div style="width:55%; display:flex;">
                ...
                <p style="font-size:20px;padding-top: 10px; padding-left: 35px; box-sizing: border-box;"></p>
            </div>
            <div style="width:45%; display:flex">
                ...
                <p style="font-size:20px;padding-top: 10px; box-sizing: border-box;"></p>
            </div>
        </div>
        <div style="width:100%; display:flex;">
            ...
            <p style="font-size:20px; padding-left: 5px; padding-top: 10px; box-sizing: border-box;"></p>
        </div>
    </section>
...
.pull-right{position: absolute;bottom: 0; right: 50px;}
    ...
    <div class="hidden-print">
        <div class="pull-right">
            <a href="{{route ('chalan.index')}}" class="btn btn-danger btn-lg">Back</a>
